...
namespace CustomizationsInTsp
{
    ...
    public partial class CustomizationsInTspClient
    {
        ...
        /// <param name="modelToRename"> Renamed model (original name: ModelToRename). </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual async Task<Response<RenamedModel>> FooAsync(RenamedModel modelToRename, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Response<RenamedModel> Foo(RenamedModel modelToRename, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(modelToRename, nameof(modelToRename));
